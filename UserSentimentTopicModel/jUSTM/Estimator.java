...
public class Estimator {
        ...
        public int sampling(int m, int n){
               ...
               { System.out.println("nal "+trnModel.nal[current_author][topic][senti_label]);
                ...
                trnModel.ndl[m][topic][senti_label]-=1;
                trnModel.ndlsum[m][senti_label]-=1;
                ...
                //* trnModel.word_weights[w][m];
                trnModel.ndl[m][topic][_sentiment]++;
                trnModel.ndlsum[m][_sentiment]++;
                return topic;
        }
        ...
        public void computeTheta(){
            	...
            	for (int m = 0; m < trnModel.M; m++){
        			for (int k = 0; k < trnModel.K; k++){
        				for(int s =0;s<trnModel.S;s++)
        				{
        					trnModel.theta_doc[m][k][s] = (trnModel.ndl[m][k][s] + trnModel.alpha) / (trnModel.ndlsum[m][s] + trnModel.K * trnModel.alpha);
