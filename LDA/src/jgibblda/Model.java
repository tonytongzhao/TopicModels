...
public class Model {	
	...
	protected boolean readOthersFile(String otherFile){
		...
		try {
			...
			while((line = reader.readLine()) != null){
				...
				else if (optstr.equalsIgnoreCase("nauthors")){
	...
	public boolean initNewModel(LDACmdOption option, Model trnModel){
		...
		LDADataset dataset = LDADataset.readDataSet(dir + File.separator + dfile, trnModel.data.localDict,option);
		if (dataset == null){
